...
<head>
  ...
  <meta name="description" content="Selamat Datang Persediaan Barang FM Regional Bandung" />
  <meta name="author" content="Facility Management" />

  <!-- Title -->
  <title>Selamat Datang Persediaan Barang FM Regional Bandung</title>

  <!-- Favicon icon -->
  <link rel="icon" href="assets/img/FM.jpg" type="image/x-icon" />
...
<body class="login">
  ...
  <div class="wrapper wrapper-login">
    <div class="container container-login animated fadeIn">
      <!-- logo -->
      <div class="text-center mb-4"><img src="assets/img/FM.JPG" alt="Logo" width="95px"></div>
      <!-- judul -->
      <h3 class="text-center">Aplikasi Persediaan Barang <br>FM Regional Bandung</h3>
      <!-- form login -->
      <form action="proses_login.php" method="post" class="needs-validation" novalidate>
        ...
        <div class="login-footer mt-4">
          <span class="msg">&copy; Facility Management</span>
         </div>
      </form>
    </div>
  </div>
