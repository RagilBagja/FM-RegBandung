<!-- Persediaan Barang Facility Management Regional Bandung
************************************************************************
* Developer   : Code Null
* Company     : Code Null
* Release     : Mei 2021
...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="Persediaan Barang Facility Management Regional Bandung" />
    <meta name="author" content="Facility Management" />

    <!-- Title -->
    <title>Facility Management Regional Bandung</title>
        ...
        <div class="logo-header" data-background-color="purple">
          ...
          <a href="?module=dashboard" class="logo">
            <div class="navbar-brand">
              <span><i class=""></i></span>
              <span class="text-white">FM Bandung</span>
            </div>
          </a>
          <!-- Navbar Toggler -->
